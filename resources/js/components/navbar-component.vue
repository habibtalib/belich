<template>
    <nav id="nav-navbar" class="relative w-full select-none bg-teal lg:flex lg:items-stretch">
        <div class="flex flex-no-shrink items-stretch h-12">
            ...
            <button @click="menuToggle" class="relative block text-white hover:text-yellow cursor-pointer ml-auto w-12 h-12 p-4 outline-none lg:hidden">
        ...
        <div :class="isMobile ? 'block' : 'hidden'" class="lg:flex lg:items-stretch lg:flex-no-shrink lg:flex-grow">
